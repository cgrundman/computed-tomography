...
[det_x,det_y] = detector_position_xy(DCD_mm, angle_deg, n_dexel, ...
    dexel_size_mm);
...
for dexel = 1:n_dexel
    ...
    [S(dexel), H(dexel)] = line_integral_xy(image_data, pixel_size_mm, ...
        source_x, source_y, det_x(dexel), det_y(dexel));
end
